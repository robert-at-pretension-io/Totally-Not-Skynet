...
## Todo:
Make sure the system described is unambiguous and clearly defined. All of the roles, channels of communication, system objects and prerogatives should make sense and provide clear direction.