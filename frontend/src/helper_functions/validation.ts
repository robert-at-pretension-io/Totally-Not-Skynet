import { Prompt } from "system_types";

export function populateInputVariables(action: Prompt): string[] {
...
export function populateOutputVariables(action: Prompt): string[] {
