...
export class Node extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.input_variables.length)
            writer.writeRepeatedString(2, this.input_variables);
        if (this.output_variables.length)
            writer.writeRepeatedString(3, this.output_variables);
        if (this.node_type != NodeTypes.PROMPT)
...
export class Log extends pb_1.Message {
    ...
    get log_type() {
        return pb_1.Message.getFieldWithDefault(this, 3, LogMessageTypes.LogInfo) as LogMessageTypes;
    }
    set log_type(value: LogMessageTypes) {
        pb_1.Message.setField(this, 3, value);
    }
    static fromObject(data: {
        message?: string;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.log_type != LogMessageTypes.LogInfo)
            writer.writeEnum(3, this.log_type);
        if (!w)
            return writer.getResultBuffer();
    }
...
export class AtomicExecutionLog extends pb_1.Message {
    ...
    set response(value: Map<string, Value>) {
    ...
    static fromObject(data: {
        ...
        if (typeof data.response == "object") {
            message.response = new Map(Object.entries(data.response).map(([key, value]) => [key, Value.fromObject(value)]));
        }
        if (data.node_info != null) {
            message.node_info = GraphNodeInfo.fromObject(data.node_info);
        }
...
export class Value extends pb_1.Message {
    ...
    get string_list() {
        return pb_1.Message.getWrapperField(this, StringList, 3) as StringList;
    }
    ...
    get value_type() {
        const cases: {
            [index: number]: "none" | "string_value" | "number_value" | "string_list";
        } = {
            0: "none",
            1: "string_value",
            2: "number_value",
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_string_list)
            writer.writeMessage(3, this.string_list, () => this.string_list.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
...
export class SystemState extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        ...
        if (!Array.isArray(data) && typeof data == "object") {
            ...
            if ("execution_results" in data && data.execution_results != undefined) {
                this.execution_results = data.execution_results;
            }
    ...
    set execution_results(value: Execution[]) {
    ...
    get session() {
        return pb_1.Message.getWrapperField(this, Session, 14) as Session;
    }
    ...
    static fromObject(data: {
        ...
        execution_results?: ReturnType<typeof Execution.prototype.toObject>[];
        ...
        if (data.execution_results != null) {
            message.execution_results = data.execution_results.map(item => Execution.fromObject(item));
        }
    ...
    toObject() {
        ...
        if (this.execution_results != null) {
            data.execution_results = this.execution_results.map((item: Execution) => item.toObject());
        }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.execution_results.length)
            writer.writeRepeatedMessage(7, this.execution_results, (item: Execution) => item.serialize(writer));
        ...
        if (this.has_session)
            writer.writeMessage(14, this.session, () => this.session.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    reader.readMessage(message.execution_results, () => pb_1.Message.addToRepeatedWrapperField(message, 7, Execution.deserialize(reader), Execution));
                    break;
                case 8:
...
export class Secrets extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        email?: string;
        password?: string;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Secrets {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new Secrets();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): Secrets {
        return Secrets.deserialize(bytes);
    }
}
export class AuthenticationMessage extends pb_1.Message {
    ...
    get secrets() {
        return pb_1.Message.getWrapperField(this, Secrets, 1) as Secrets;
    }
    set secrets(value: Secrets) {
        pb_1.Message.setOneofWrapperField(this, 1, this.#one_of_decls[0], value);
    }
    get has_secrets() {
        return pb_1.Message.getField(this, 1) != null;
    ...
    get body() {
        const cases: {
            [index: number]: "none" | "secrets" | "session";
        } = {
            0: "none",
            1: "secrets",
            2: "session"
    ...
    static fromObject(data: {
        secrets?: ReturnType<typeof Secrets.prototype.toObject>;
        session?: ReturnType<typeof Session.prototype.toObject>;
    }): AuthenticationMessage {
        const message = new AuthenticationMessage({});
        if (data.secrets != null) {
            message.secrets = Secrets.fromObject(data.secrets);
        }
        if (data.session != null) {
            message.session = Session.fromObject(data.session);
        }
    ...
    toObject() {
        ...
        if (this.secrets != null) {
            data.secrets = this.secrets.toObject();
        }
        if (this.session != null) {
            data.session = this.session.toObject();
        }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.has_secrets)
            writer.writeMessage(1, this.secrets, () => this.secrets.serialize(writer));
        if (this.has_session)
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AuthenticationMessage {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.secrets, () => message.secrets = Secrets.deserialize(reader));
                    break;
                case 2:
                    reader.readMessage(message.session, () => message.session = Session.deserialize(reader));
                    break;
