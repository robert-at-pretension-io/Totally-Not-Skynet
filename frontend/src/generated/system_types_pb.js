 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.skynet.types.ValidateNodes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.skynet.types.ValidateNodes}
 */
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.skynet.types.ValidateNodes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.skynet.types.CrudBundle.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getValidateNodes();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.skynet.types.ValidateNodes.serializeBinaryToWriter
    );
  }
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.skynet.types.ValidateNodesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.skynet.types.ValidateNodesResponse}
 */
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.skynet.types.ValidateNodesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.skynet.types.ResponseObject.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getValidateNodesResponse();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
